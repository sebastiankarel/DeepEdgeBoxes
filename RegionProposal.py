...
def create_data_from_split_files():
    hed = HED()
...
def get_discriminator_model():
    ...
    model.add(keras.layers.Conv2D(64, (3, 3), activation='relu', name="conv_1_1", trainable=False, input_shape=(img_height, img_width, img_channels)))
...
def train_discriminator_model(model, load_weights):
    if load_weights:
